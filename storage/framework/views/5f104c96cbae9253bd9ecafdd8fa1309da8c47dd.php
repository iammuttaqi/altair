    ...
    <div class="sidebar_main_header">
        <div class="sidebar_logo">
            <a href="<?php echo e(route('home')); ?>" class="sSidebar_hide sidebar_logo_large">
                <img class="logo_regular" src="<?php echo e(asset('assets/img/logo_main.png')); ?>" alt="Admin" style="width: 85%; margin-top: 25px;"/>
...
</aside><!-- main sidebar end --><?php /**PATH C:\laragon\www\altair\resources\views/layouts/backend/includes/sidebar.blade.php ENDPATH**/ ?>