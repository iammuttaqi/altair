...
<?php $__env->startSection('title', 'Further Sub Category Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php echo Form::open(['url' => route("further_subcategory_update", $furtherSubCategory['id']), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']); ?>
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="further_sub_category_name" name="further_sub_category_name" value="<?php echo e($furtherSubCategory->name); ?>" required="required">
                                            ...
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $further_sub_category_input_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $further_sub_category_input_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($further_sub_category_input_value->inputFieldId->name); ?></td>
                                                            <td><?php echo $helper->setForFurtherSubCategoryValues($further_sub_category_id, $further_sub_category_input_value['input_fields_id']); ?></td>
                                                        </tr>
