...
<?php $__env->startSection('title', 'Sub Category Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php echo Form::open(['url' => route("sub_category_update", $sub_category->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']); ?>
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <input type="hidden" name="category_id" id="category_id" value="<?php echo e($sub_category->category_id); ?>">
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="sub_category_name" name="sub_category_name" value="<?php echo e($sub_category->name); ?>" required="required" <?php echo e($sub_category->id == 65 ? 'readonly' : ($sub_category->id == 66 ? 'readonly' : '')); ?>>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-5-5">
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                <?php $__currentLoopData = $sub_category_input_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sub_category_input_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($sub_category_input_value->sub_cat_input_name); ?></td>
                                                        <td><?php echo $helper->setForSubCategoryValues($sub_category['id'], $sub_category_input_value['input_fields_id']); ?></td>
                                                    </tr>
                                            ...
                                            <table class="uk-table">
                                                ...
                                                <?php $__currentLoopData = $input_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $input_field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" name="input_fields_id[<?php echo e($input_field->id); ?>]" id="input_fields_id_<?php echo e($input_field->id); ?>" value="<?php echo e($input_field->id); ?>" <?php echo e((isset($furtherSubCatInputField[$input_field->id]) ? 'checked' : '')); ?> data-md-icheck/> </td>
                                                        <td><input class="md-input" type="text" name="further_sub_cat_input_name[<?php echo e($input_field->id); ?>]" id="further_sub_cat_input_name<?php echo e($input_field->id); ?>" value="<?php echo e((isset($furtherSubCatInputField[$input_field->id]) ? $furtherSubCatInputField[$input_field->id] : '')); ?>"/> </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
