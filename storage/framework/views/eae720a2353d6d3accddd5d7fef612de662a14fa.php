      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-4 footer__widget footer__widget-about">
          <div class="footer__widget-content">
            <img src="assets/images/logo/logo-dark.png" width="134px" height="50px" alt="logo" class="mb-30">
            ...
            <p><a href="https://www.linkedin.com/company/diaplousng" target="_blank"><img src="assets/images/linkedin.png" width="20px"></a></p>
          </div>
        </div><!-- /.col-lg-4 -->
        ...
        <div class="col-6 col-sm-6 col-md-3 col-lg-2 footer__widget footer__widget-nav">
          <h6 class="footer__widget-title">Maritime Services</h6>
          <div class="footer__widget-content">
            <nav>
              <ul class="list-unstyled">
                <li ><a href="single-service.php">Security Escort Vessels - ARMED</a></li>
                <li ><a href="single-service1.php">Navy Teams - ARMED</a></li>
                <li ><a href="single-service2.php">Maritime Security Liaison Officers - UNARMED</a></li>
                <li ><a href="single-service3.php">K9 stowaway search - ARMED / UNARMED</a></li>
              </ul>
            </nav>
          </div><!-- /.footer-widget-content -->
        </div><!-- /.col-lg-2 -->
        <div class="col-6 col-sm-6 col-md-3 col-lg-2 footer__widget footer__widget-nav">
          <h6 class="footer__widget-title">Port Agency Services</h6>
          <div class="footer__widget-content">
            <nav>
              <ul class="list-unstyled">
                <li ><a href="single-service4.php">Port Agency Services</a></li>
                <li ><a href="single-service5.php">HAS & OPA</a></li>
              </ul>
            </nav>
          </div><!-- /.footer-widget-content -->
        </div><!-- /.col-lg-2 -->
        <div class="col-6 col-sm-6 col-md-3 col-lg-2 footer__widget footer__widget-nav">
          <h6 class="footer__widget-title">Other Links</h6>
          <div class="footer__widget-content">
            <nav>
              <ul class="list-unstyled">
      ...
      <div class="row mt-20">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="carousel owl-carousel" data-slide="6" data-slide-md="4" data-slide-sm="2" data-autoplay="true" data-nav="false" data-dots="false" data-space="20" data-loop="true" data-speed="200">
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c1.jpg" alt="Nigerian Navy"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c2.jpg" alt="Civil Defence"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c3.jpg" alt="Partner"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c4.jpg" alt="Nigerian Maritime Administration & Safety Agency"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c5.jpg" alt="Nigerian Petrolium Exchange"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c6.jpg" alt="The Nigeria Police"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c7.jpg" alt="Maritime Security Providers Association Of Nigeria"></a>
                </div>
                <div class="client">
                    <a href="#!"><img src="assets/images/clients/c8.jpg" alt="BIMCO"></a>
                </div>
            </div><!-- /.carousel -->
        </div><!-- /.col-lg-12 -->
    </div><!-- /.row -->
