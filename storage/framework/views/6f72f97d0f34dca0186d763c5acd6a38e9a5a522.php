<?php $__env->startSection('title'); ?>
  <?php echo e($renovation_header[0]['category_value'] ?? ''); ?> | Decor
...
<section class="page-title" style="background-image:url(<?php echo e($renovation_header[2]['category_value'] ?? ''); ?>)">
	<div class="auto-container">
		<h1><?php echo e($renovation_header[1]['category_value'] ?? ''); ?></h1>
		<ul class="page-breadcrumb">
			<li><a href="home.html#services">Services</a></li>
			<li><?php echo e($renovation_header[1]['category_value'] ?? ''); ?></li>
		</ul>
	</div>
</section>
<!--End Page Title-->
				...
				<div class="services-single">
					<div class="inner-service">
						...
						<?php if(isset($about) > 0): ?>
							<?php $__currentLoopData = $about; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="feature-about">
								
								<h2><?php echo e($abt['title'] ?? ''); ?></h2>
								<p><?php echo $abt['details'] ?? ''; ?></p>
