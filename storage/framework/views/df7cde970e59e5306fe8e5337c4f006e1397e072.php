    ...
    <div class="col-sm-12 col-md-12 col-lg-5">
      <form action="<?php echo e(route('send-mail')); ?>" method="post">
        ...
        <div class="form-group d-flex">
          <input type="email" class="form-control mr-30" name="email" placeholder="Your Email Address">
          <button type="submit" class="btn btn__primary btn__hover3">Sign Up!</button>
        </div>
      </form>
    </div><!-- /.col-lg-5 -->
  </div><!-- /.row -->
