                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="module_name" name="module_name" value="<?php echo e($module->name); ?>" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <p>
                                            <input type="checkbox" name="further_sub_category" id="further_sub_category" <?php if($module->sub_category == 1): ?> checked <?php endif; ?> value="1" data-md-icheck/>
