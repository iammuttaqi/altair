...
<?php $__env->startSection('content'); ?>
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php echo Form::open(['url' => route("category_store",$module_id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']); ?>
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" name="modules_id" id="modules_id" class="form-control" disabled>
                                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modules): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($modules->id); ?>" <?php if($modules->id == $module_id): ?> selected readonly <?php endif; ?>><?php echo e($modules->name); ?></option>
                                    ...
                                    <input type="hidden" name="modules_id" id="modules_id" value="<?php echo e($module_id); ?>">
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="category_name" name="category_name" value="<?php echo e(old('category_name')); ?>" required="required">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-5-5">
                                        <table class="uk-table">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $category_input_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_input_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($category_input_value->name); ?></td>
                                                    <td><?php echo $category_input_value->inputFieldId->code; ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="uk-table">
                                            ...
                                            <?php $__currentLoopData = $input_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $input_field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><input class="md-input" type="text" name="sub_cat_input_name[<?php echo e($input_field->id); ?>]" id="sub_cat_input_name<?php echo e($input_field->id); ?>" value=""/> </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
