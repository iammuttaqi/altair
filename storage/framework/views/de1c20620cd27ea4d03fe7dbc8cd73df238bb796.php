<?php $__env->startSection('title'); ?>
  <?php echo e($adc_header[0]['category_value'] ?? ''); ?> | Decor
...
<section class="page-title" style="background-image:url(<?php echo e($adc_header[2]['category_value'] ?? ''); ?>)">
	<div class="auto-container">
		<h1><?php echo e($adc_header[1]['category_value'] ?? ''); ?></h1>
		<ul class="page-breadcrumb">
			<li><a href="home.html#services">Services</a></li>
			<li><?php echo e($adc_header[1]['category_value'] ?? ''); ?></li>
		</ul>
	</div>
</section>
<!--End Page Title-->
