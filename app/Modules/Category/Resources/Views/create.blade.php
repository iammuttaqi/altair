...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            {!! Form::open(['url' => route("category_store",$module_id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']) !!}
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select class="md-input" name="modules_id" id="modules_id" class="form-control" disabled>
                                            @foreach($modules as $modules)
                                                <option value="{{ $modules->id }}" @if($modules->id == $module_id) selected readonly @endif>{{ $modules->name }}</option>
                                            @endforeach
                                       </select>
                                    ...
                                    <input type="hidden" name="modules_id" id="modules_id" value="{{ $module_id }}">
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="category_name" name="category_name" value="{{ old('category_name') }}" required="required">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-5-5">
                                        <table class="uk-table">
                                            ...
                                            <tbody>
                                                @foreach($category_input_values as $category_input_value)
                                                <tr>
                                                    <td>{{ $category_input_value->name }}</td>
                                                    <td>{!! $category_input_value->inputFieldId->code !!}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="uk-table">
                                            ...
                                            @foreach($input_fields as $input_field)
                                                <tr>
                                                    ...
                                                    <td><input class="md-input" type="text" name="sub_cat_input_name[{{ $input_field->id }}]" id="sub_cat_input_name{{ $input_field->id }}" value=""/> </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
