                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="further_sub_category_name" name="further_sub_category_name" value="{{ old('further_sub_category_name') }}" required="required">
                                        ...
                                        <div class="uk-width-medium-1-1">
                                            <table class="uk-table">
                                                ...
                                                @foreach($further_sub_category_input_values as $key => $further_sub_category_input_value)
                                                    <tr>
                                                        <td>{{ $further_sub_category_input_value->further_sub_cat_input_name }}</td>
                                                        <td>{!! $further_sub_category_input_value->inputFieldId->code !!}</td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
