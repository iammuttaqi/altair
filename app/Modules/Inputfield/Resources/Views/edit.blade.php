...
@section('title', 'Input Field Update')
...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            {!! Form::open(['url' => route("inputfield_update", $input_field->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']) !!}
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update Input Field</span></h2>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="name" name="name" value="{{ $input_field->name  }}" required="required">
                                        @if($errors->has('name'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="slug_name" name="slug_name" value="{{ $input_field->slug_name }}" required="required">
                                        @if($errors->has('name'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-3-5">
                                        ...
                                        <input class="md-input" type="text" name="code" id="code" value="{{ $input_field->code  }}" required="required" >
                                        @if($errors->has('code'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <select class="md-input" name="type" id="type" class="form-control">
                                            ...
                                            <option value="1" @if($input_field->type == 1) selected @endif>File</option>
                                        </select>
                                        @if($errors->has('type'))
                                            <br/>
