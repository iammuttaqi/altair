...
@section('content')
    ...
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            {!! Form::open(['url' => route("module_store"), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => true, 'enctype' => "multipart/form-data", 'novalidate']) !!}
                                        ...
                                        <table class="uk-table">
                                            ...
                                            @foreach($input_fields as $input_field)
                                                <tr>
                                                    ...
                                                    <td><input class="md-input" type="text" name="name[{{ $input_field->id }}]" id="name{{ $input_field->id }}" value=""/></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
